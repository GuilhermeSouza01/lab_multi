...
function appointment_booking_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'appointment_booking_slidersettings' , array(
    	...
    	'description' => __('Free theme has 3 slides options, For unlimited slides and more options </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/appointment-wordpress-theme/">GET PRO</a>','appointment-booking'),
		'panel' => 'appointment_booking_panel_id'
	) );
   ...
   $wp_customize->add_setting('appointment_booking_slider_image_overlay_color', array(
	...
	$wp_customize->add_section('appointment_booking_services',array(
		...
		'description' => __('For more options of services section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/appointment-wordpress-theme/">GET PRO</a>','appointment-booking'),
		'panel' => 'appointment_booking_panel_id',
	));
	...
	$wp_customize->add_section('appointment_booking_about',array(
		...
		'description' => __('For more options of about section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/appointment-wordpress-theme/">GET PRO</a>','appointment-booking'),
		'panel' => 'appointment_booking_panel_id',
	));
	...
	$wp_customize->add_section('appointment_booking_footer',array(
		...
		'description' => __('For more options of footer section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/appointment-wordpress-theme/">GET PRO</a>','appointment-booking'),
		'panel' => 'appointment_booking_panel_id',
	));
