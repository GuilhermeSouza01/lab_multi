<?php
	...
	if($appointment_booking_second_color != false){
		$appointment_booking_custom_css .='.more-btn a, nav.navigation.posts-navigation .nav-previous a, nav.navigation.posts-navigation .nav-next a{
			border-color: '.esc_html($appointment_booking_second_color).';
		}';
	}

	if($appointment_booking_second_color != false){
		$appointment_booking_custom_css .='nav.navigation.posts-navigation .nav-previous a:hover, nav.navigation.posts-navigation .nav-next a:hover, .wp-block-button.is-style-outline a, .wp-block-button .wp-block-button__link:hover{
