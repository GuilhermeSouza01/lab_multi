...
= 0.4.4 =
* Done slider sec & services sec , about sec css of block pattern in tab media.
...
* Resolved error of On loading screen services section, logo are showing.
...
* Resolved error of when open search popup and scrollup is dispalying.
...
* Added show / hide blog pagination in post settings.
* Added blog pagination in post settings.
* Update language folder.
...
* Resolved about us and services section error.
* Added css for active menu css.
...
* Resolved error for cart page product title.
...
* Added phone, mail, open and close search icon setting in customizer.
* Resolved menu css issue.
* Update pot file.
...
= 0.9.6 =
* Resolved services section condition.  
...
== Fonts ==
* Muli *
* Source : https://fonts.google.com/specimen/Mulish?query=Muli
...
== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-appointment-booking/
